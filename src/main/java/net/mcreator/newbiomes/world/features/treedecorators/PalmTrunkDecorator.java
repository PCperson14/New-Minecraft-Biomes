...
@EventBusSubscriber
public class PalmTrunkDecorator extends TrunkVineDecorator {
	public static MapCodec<PalmTrunkDecorator> CODEC = MapCodec.unit(PalmTrunkDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(Registries.TREE_DECORATOR_TYPE, ResourceLocation.parse("new_biomes:palm_tree_trunk_decorator"), () -> DECORATOR_TYPE);
	}
