package net.mcreator.newbiomes.world.features.treedecorators;
...
@EventBusSubscriber
public class PalmLeaveDecorator extends LeaveVineDecorator {
	public static MapCodec<PalmLeaveDecorator> CODEC = MapCodec.unit(PalmLeaveDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(Registries.TREE_DECORATOR_TYPE, ResourceLocation.parse("new_biomes:palm_tree_leave_decorator"), () -> DECORATOR_TYPE);
	}

	public PalmLeaveDecorator() {
		super(0.25f);
	}
