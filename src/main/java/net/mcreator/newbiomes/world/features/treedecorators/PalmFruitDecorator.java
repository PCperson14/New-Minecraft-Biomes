...
@EventBusSubscriber
public class PalmFruitDecorator extends CocoaDecorator {
	public static MapCodec<PalmFruitDecorator> CODEC = MapCodec.unit(PalmFruitDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(Registries.TREE_DECORATOR_TYPE, ResourceLocation.parse("new_biomes:palm_tree_fruit_decorator"), () -> DECORATOR_TYPE);
	}

	public PalmFruitDecorator() {
		super(0.2f);
	}
