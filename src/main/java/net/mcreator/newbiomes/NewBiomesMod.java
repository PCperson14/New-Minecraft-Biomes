package net.mcreator.newbiomes;
...
import net.mcreator.newbiomes.init.NewBiomesModTabs;
import net.mcreator.newbiomes.init.NewBiomesModItems;
import net.mcreator.newbiomes.init.NewBiomesModBlocks;
...
@Mod("new_biomes")
public class NewBiomesMod {
	public static final Logger LOGGER = LogManager.getLogger(NewBiomesMod.class);
	public static final String MODID = "new_biomes";

	public NewBiomesMod(IEventBus modEventBus) {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		NeoForge.EVENT_BUS.register(this);
		modEventBus.addListener(this::registerNetworking);
		NewBiomesModBlocks.REGISTRY.register(modEventBus);
		NewBiomesModItems.REGISTRY.register(modEventBus);
		NewBiomesModTabs.REGISTRY.register(modEventBus);
